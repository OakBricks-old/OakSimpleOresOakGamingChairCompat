...
package compact.oakbricks.simpleoreschairscompat.world.structure;
...
public class TeststructStructure extends SimpleoreschairscompatModElements.ModElement {
	public TeststructStructure(SimpleoreschairscompatModElements instance) {
		super(instance, 9);
				...
				if ((random.nextInt(1000000) + 1) <= 10000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = world.getWorld().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("simpleoreschairscompat", "home"));
						if (template == null)
							return false;
