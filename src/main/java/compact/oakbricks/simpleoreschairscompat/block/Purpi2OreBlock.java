...
public class Purpi2OreBlock extends SimpleoreschairscompatModElements.ModElement {
	@ObjectHolder("simpleoreschairscompat:purpi_2_ore")
	public static final Block block = null;
	public Purpi2OreBlock(SimpleoreschairscompatModElements instance) {
		super(instance, 2);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Purpi2Item.block, (int) (1)));
		}
	}
	@SubscribeEvent
